...
const Databox = ({title, qty, qtyPercentage, profit}) => (
    ...
    const Bar =({title,value,profit})=>(
        <Box py={"4"} px={["0","20"]}>
        <Heading size={"sm"} children={title} m={"2"} />
    ...
    return <Grid css={{
        ...
        <Box
            ...
            >
                ...
                <Databox title="Subscription" qty={13} qtyPercentage={20} profit={false} />
            ...
            <Heading textAlign={["center","lefgt"]} size={"md"} children="Views Graph" pt={["8","0"]} ml={["0","16"]} />
            {/* {Line graph here} */}
            <LineChart />
            ...
            <Box p={["0","16"]} boxSizing="bordder-box" py={"4"}>
            <Heading textAlign={"center"} mb={"4"} children="Users" />
            {/* {Doughnut Graph} */}
            <DoughnutChart />
